...
/**
 * SocialAuthButtons component - displays social OAuth login buttons.
 *
 * Shows buttons for Google and GitHub sign-in.
 * Uses Better Auth's social sign-in functionality.
 */
